...
-   The practice report will not be individually graded. Instead, we will release the solution file so that you can compare your code to our solution as generic feedback. If you would like to discuss any aspect of the report, you can attend office hours with the course leads.
...
-   There are two files you need to download. The first is the dataset: <a href="https://healthteachr.github.io/ads-v2/data/review_data.csv" download>review_data.csv</a>. The second is the finished report that you need to backwards engineer from the data: [formative_report_output.html](https://healthteachr.github.io/ads-v2/data/formative_report_output.html).
