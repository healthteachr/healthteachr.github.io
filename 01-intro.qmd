...
The glossary at the end of each chapter defines common jargon you might encounter while learning R. This specialised vocabulary can help you to communicate more efficiently and to search for solutions to problems. The terms below feature in our [HealthTeachR glossary](https://healthteachr.github.io/glossary/), which contains further information and examples.
