...
`r kable(participants, caption="Demo participants table.")`
...
`r kable(activity, caption="Demo activity table.")`
...
file.remove("data/participants1.csv")
file.remove("data/participants2.csv")
```
...
Let's recreate our `new_participants` dataset but this time, we'll specify that `id` is a `r glossary("character")` variable.
