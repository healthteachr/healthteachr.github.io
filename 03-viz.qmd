...
* Which category is characterised by the slowest median gait speed? `r mcq(ans1)`
* Which category is characterised by the quickest median gait speed? `r mcq(ans2)`
:::
